...
class Data{
  ...
  static List<Category> getCategories() => <Category>[
    ...
    new Category(id: 1, name:'Ana Yemekler', foods: mainfoods) //deneme
  ];
  ...
  static List<Food> getSoups() => <Food>[
    new Food(id: 0, name: 'Mercimek Çorbası', ingredients: <Ingrediendt>[
      ...
      new Ingrediendt(id: ingredients[9].id, name: ingredients[9].name, quantity: 50)], image: 'assets/images/foto0.jpg'),
    new Food(id: 1, name: 'Ezogelin Çorbası', ingredients: <Ingrediendt>[new Ingrediendt(id: ingredients[0].id, name: ingredients[0].name, quantity: 100),
      new Ingrediendt(id: ingredients[1].id, name: ingredients[1].name, quantity: 10),
      new Ingrediendt(id: ingredients[10].id, name: ingredients[10].name, quantity: 100),
      new Ingrediendt(id: ingredients[4].id, name: ingredients[4].name, quantity: 10)],image: 'assets/images/foto1.jpg'),
    new Food(id: 2, name: 'Tavuk Suyu Çorbası', ingredients: <Ingrediendt>[
      new Ingrediendt(id: ingredients[1].id, name: ingredients[1].name, quantity: 10),
      new Ingrediendt(id: ingredients[11].id, name: ingredients[11].name, quantity: 200),
      new Ingrediendt(id: ingredients[4].id, name: ingredients[4].name, quantity: 10)],image: 'assets/images/foto2.jpg')
  ];
  static List<Food> getMainFood() => <Food>[
    new Food(id: 0, name: 'Karnı Yarık', ingredients: <Ingrediendt>[
      new Ingrediendt(id: ingredients[0].id, name: ingredients[0].name, quantity: 50),
      new Ingrediendt(id: ingredients[1].id, name: ingredients[1].name, quantity: 10),
      new Ingrediendt(id: ingredients[8].id, name: ingredients[8].name, quantity: 100),
      new Ingrediendt(id: ingredients[9].id, name: ingredients[9].name, quantity: 50)], image: 'assets/images/foto100.jpg'),
    new Food(id: 1, name: 'Pilav', ingredients: <Ingrediendt>[
      new Ingrediendt(id: ingredients[0].id, name: ingredients[0].name, quantity: 50),
      new Ingrediendt(id: ingredients[1].id, name: ingredients[1].name, quantity: 10),
      new Ingrediendt(id: ingredients[8].id, name: ingredients[8].name, quantity: 100),
      new Ingrediendt(id: ingredients[9].id, name: ingredients[9].name, quantity: 50)],image: 'assets/images/foto101.jpg'),
    new Food(id: 2, name: 'Nohut Yemeği', ingredients: <Ingrediendt>[
      new Ingrediendt(id: ingredients[0].id, name: ingredients[0].name, quantity: 50),
      new Ingrediendt(id: ingredients[1].id, name: ingredients[1].name, quantity: 10),
      new Ingrediendt(id: ingredients[8].id, name: ingredients[8].name, quantity: 100),
      new Ingrediendt(id: ingredients[9].id, name: ingredients[9].name, quantity: 50)],image: 'assets/images/foto102.jpg')
  ];
